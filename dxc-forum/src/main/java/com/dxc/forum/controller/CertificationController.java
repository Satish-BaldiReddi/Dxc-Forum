...
public class CertificationController {
	...
	public ResponseEntity<?> updatCertificationEntity(@RequestBody Certification certificationEntity,
		...
		try {
		    Certification certificationUpdated= this.certificationService.updateCerticationEntity(certificationEntity, id);
		    return new ResponseEntity<Certification>(certificationUpdated, HttpStatus.CREATED);
		}
		catch(BusinessException e) {
			ControllerException ce= new ControllerException(e.getErrorcode(),e.getErrorMsg());
			return new ResponseEntity<ControllerException>(ce, HttpStatus.BAD_REQUEST);
